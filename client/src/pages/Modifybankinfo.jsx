...
import { modifyBankInfo } from "../utils/slice";
...
const Modifybankinfo = () => {
  ...
  const onSubmit = (data) => {
    ...
    formData.append("OldBankName", data.OldBankName);
    formData.append("OldBeneficiaryName", data.OldBeneficiaryName);
    formData.append("OldAccountNumber", data.OldAccountNumber);
    formData.append("OldIFSCCode", data.OldIFSCCode);
    formData.append("NewBankName", bank);
    formData.append("NewBeneficiaryName", data.NewBeneficiaryName);
    formData.append("NewAccountNumber", data.NewAccountNumber);
    formData.append("NewIFSCCode", data.NewIFSCCode);
    ...
    if (data.OldPassbook && data.OldPassbook[0]) {
      formData.append("OldPassbook", data.OldPassbook[0]);
    }

    if (data.NewPassbook && data.NewPassbook[0]) {
      formData.append("NewPassbook", data.NewPassbook[0]);
    }
    ...
    dispatch(modifyBankInfo(formData)).then((res) => {
            ...
            <div>
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      ...
                      name="BankName"
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.BankName
                          ? "border-red-500"
                          : "border-gray-300"
                        }`}
                    />
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      ...
                      name="OldBankName"
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.OldBankName
                          ? "border-red-500"
                          : "border-gray-300"
                        }`}
                    />
              ...
              <div className="relative p-4 sm:p-6 w-full text-gray-800 text-base sm:text-2xl flex flex-col items-center">
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      {...register("OldBeneficiaryName", {
                        required: "Please enter content",
                      })}
                      type="text"
                      id="OldBeneficiaryName"
                      placeholder="Please enter content"
                      name="OldBeneficiaryName"
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.OldBeneficiaryName
                          ? "border-red-500"
                          : "border-gray-300"
                        }`}
                    />
                  ...
                  {/* Error Message */}
                  {errors.OldBeneficiaryName && (
                    <div className="text-red-600 text-left font-normal text-xs sm:text-base lg:text-lg mt-2">
                      {errors.OldBeneficiaryName.message}
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      ...
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.OldAccountNumber ? "border-red-500" : "border-gray-300"
                        }`}
                    />
                  </div>
                  ...
                  {errors.OldAccountNumber && (
                    <div className="text-red-600 text-left font-normal text-xs sm:text-base lg:text-lg mt-2">
                      {errors.OldAccountNumber.message}
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      ...
                      name="OldIFSCCode"
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.OldIFSCCode ? "border-red-500" : "border-gray-300"
                        }`}
                    />
                  </div>
              ...
              <div className="max-w-xs sm:max-w-md lg:max-w-lg mx-auto">
                <div className="flex ">
                  ...
                  <p className="text-sm gray-50">New Bank name</p>
                </div>
                <input
                  type="text"
              ...
              <div className="relative p-4 sm:p-6 w-full text-gray-800 text-base sm:text-2xl flex flex-col items-center">
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      {...register("NewBeneficiaryNames", {
                        required: "Please enter content",
                      })}
                      type="text"
                      id="NewBeneficiaryNames"
                      placeholder="Please enter content"
                      name="NewBeneficiaryNames"
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.NewBeneficiaryNames
                          ? "border-red-500"
                          : "border-gray-300"
                        }`}
                    />
                  ...
                  {/* Error Message */}
                  {errors.NewBeneficiaryNames && (
                    <div className="text-red-600 text-left font-normal text-xs sm:text-base lg:text-lg mt-2">
                      {errors.NewBeneficiaryNames.message}
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      ...
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.NewAccountNumber ? "border-red-500" : "border-gray-300"
                        }`}
                    />
                  </div>
                  ...
                  {errors.NewAccountNumber && (
                    <div className="text-red-600 text-left font-normal text-xs sm:text-base lg:text-lg mt-2">
                      {errors.NewAccountNumber.message}
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="w-full max-w-xs sm:max-w-md lg:max-w-lg">
                  ...
                  <div className="flex min-h-5 bg-white rounded-md p-3 sm:p-5 lg:p-6 shadow-md items-center w-full">
                    <input
                      ...
                      placeholder="Please enter IFSC"
                      name="NewIFSCCode"
                      className={`block w-full bg-transparent border-none focus:outline-none text-left text-sm sm:text-base lg:text-lg ${errors.NewIFSCCode
                          ? "border-red-500"
                          : "border-gray-300"
                        }`}
                    />
                ...
                <div className="overflow-visible relative text-left font-normal text-gray-500">
                  ...
                  >
                    <div className="bg-transparent p-0 flex flex-col items-center text-left resize-none">
                      ...
                      <span className="text-xl p-2">Upload</span>
                    </div>
              ...
              <div className="relative p-6 w-full overflow-hidden text-gray-800 text-2xl">
                {/* Label */}
                <div className="flex w-full text-left mb-3">
                  <label htmlFor="OldPassbook" className="text-sm sm:text-lg lg:text-xl">
                ...
                <div className="overflow-visible relative text-left font-normal text-gray-500">
                  <label
                    htmlFor="OldPassbook"
                    className="min-h-5 bg-white rounded-md p-6 shadow-xl flex flex-col items-center w-[45%] cursor-pointer"
                  >
                    <div className="bg-transparent p-0 flex flex-col items-center text-left resize-none">
                      <div className="p-2">
              ...
              <div className="relative p-6 w-full overflow-hidden text-gray-800 text-2xl">
                {/* Label */}
                <div className="flex w-full text-left mb-3">
                  <label htmlFor="NewPassbook" className="text-sm sm:text-lg lg:text-xl">
